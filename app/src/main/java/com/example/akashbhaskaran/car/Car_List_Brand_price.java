...
public class Car_List_Brand_price extends AppCompatActivity {
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(Car_List_Brand_price.this,"Fetching Data","Wait...",false,false);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                try {
                    URL url = new URL("http://www.shakadam.esy.es/car/getcar1.php");
